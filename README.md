...
1. **Bootstrap the environment** (creates `.venv`, installs Python + frontend deps; enforces Python 3.11):
...
1. **Proceduralist** — reads `.txt` files only and computes a SHA-256 hash (EAC-001).
